...
ici_demographics<- read.csv("~/Desktop/trinetx/ici_incidence_start_end2021_demo_061223.csv")
ici_demographics<- ici_demographics %>% select(-c("X"))

cardio_combined<- merge(cardio_table,ici_demographics, all.x = TRUE, by=c("patient_id"))
...
write.csv(cardio_combined_ae,"~/Desktop/trinetx/all_cardio_ae_ici_demo_061223.csv")
